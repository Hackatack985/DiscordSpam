...
userToken = ['NzMyMjExNTlyNTExNzAwMDY4.XwxTHg.WJQ9Uej6fmhBDuMTw9LFWO7Gtbo'] # User Tokens here. example 'token','token' | 'email:pass', 'token'
DiscordChannel = "746398404606951494'' # Channel ID,
...
#Server Joiner
useTokenJoin = True
inviteLink = "v2ddSKd'' # Only the last 6 digits of the invite link https://discord.gg/XXXXXX | Unless you are using email join then just the full URL
...
#DM Spam
DiscordServer = "746380702152654848'' # Server ID (https://a.safe.moe/KP4DR.png this one)
